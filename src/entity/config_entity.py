...
# HF_DEFAULT_REPO_ID = "Anuroopgowda/vehicle-insurance-model"
# HF_MODEL_FILE_NAME = "model.pkl"

@dataclass
class ModelEvaluationConfig:
    changed_threshold_score: float = MODEL_EVALUATION_CHANGED_THRESHOLD_SCORE
    hf_repo_id: str = "Anuroopgowda/vehicle-insurance-model"  # Your HF repo
    hf_model_file_name: str = "model.pkl"

@dataclass
class ModelPusherConfig:
    hf_repo_id: str = "Anuroopgowda/vehicle-insurance-model"
    hf_model_file_name: str = "model.pkl"
    hf_token: str = "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"
